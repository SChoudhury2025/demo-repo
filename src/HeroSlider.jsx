...
const HeroSlider = () => {
  ...
  // Local image-based hero slider data
  const heroSlides = [
    {
      image: "/slider/slider_1.png",
      title: "Award Winning Healthcare-Heal Craft",
      subtitle: "The Leading Multispeciality Platform 2025",
      description: "by Times Business Awards"
    },
    {
      image: "/slider/slider_2.png",
